...
namespace otobus_otomasyon
{
    public partial class seferler : System.Web.UI.Page
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //Response.Redirect("koltuksecim.aspx?fiyat=" + GridView1.SelectedRow.Cells[4].Text + "&Kalkis=" + GridView1.SelectedRow.Cells[1].Text + " &Varis="+ GridView1.SelectedRow.Cells[2].Text);
